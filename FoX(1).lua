...
os.execute('wget https://raw.githubusercontent.com/Source-FoX/FoX/main/FoX.lua')
...
gk = https.request('https://xhsoali.ml/Api-Abrag.php?text='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://xhsoali.ml/FoX-Api-Age.php?text='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
