...
if text == "راسلني" then
rpl = {"ها هلاو","انطق","كول","تحب حدو @ZzZz5Z"};
...
if text == 'م1' or text == 'م2' or text == 'م3' or text == 'م4' or text == 'م5' or text == 'م6'  or text == 'م7' or text == 'م8' then
Text = [[
**اهلا عزيزي**
...
للاستفسار راسل المطور @ZzZz5Z
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == '@ZzZz5Z' or text == '@ZzZz5Z' or text == '@IIIIlI8' then
Text = [[
 هذا مطور سورس فوكس
]]
send(msg.chat_id_, msg.id_,Text)
...
{
{text = 'مطور السورس', url="t.me/ZzZz5Z"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == "كت تويت" or text == "اسئله" then
