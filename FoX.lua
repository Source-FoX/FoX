...
database:set(bot_id.."BLACKBOTSS:ali_bot"..msg.chat_id_,"close")
end
if text == "تفعيل all" and Manager(msg) then
send(msg.chat_id_, msg.id_,'تم تفعيل all')
database:set(bot_id.."BLACKBOTSS:ali_bot"..msg.chat_id_,"open")
end
...
للاستفسار راسل المطور @QvQvQQ
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == '@QvQvQQ' or text == '@IIIIlI8' or text == 'حيدر' then
Text = [[
@QvQvQQ هذا مطور سورس فوكس
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text =="@all" and database:get(bot_id.."BLACKBOTSS:ali_bot"..msg.chat_id_) == "open" then
if database:get(bot_id.."FCFFFF:all"..msg.chat_id_..':'..msg.sender_user_id_) then  
end
...
if text == ("المميزين") or text == ("صيح المميزين") then
...
if link then                              
send(msg.chat_id_,msg.id_,'ℓɪиᴋ ɢяσᴘ  ⚥︎\n*~~~~~~~~*\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'فوكس')
send(msg.chat_id_, msg.id_,'*اسمي '..Namebot..'ᶠˣ *')
end
