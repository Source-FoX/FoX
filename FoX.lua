...
send(msg.chat_id_, msg.id_,'اصدار سورس فوڪس الاول 1') 
end
...
send(msg.chat_id_,0,"•عذرا يا > {["..data.first_name_.."](T.ME/IIIIlI8)}\n• المتحركه التي ارسلتها تم منعها من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'•  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 ??𝒊𝒈𝒈𝒂 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
database:srem(bot_id..'Muted:User'..msg.chat_id_, userid)
...
Text = '*•تمہ تفعيࢦ مغادࢪة اࢦبوت•*'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = '*•باࢦتاڪيد تمہ تفعيࢦ مغادࢪة اࢦبوت•*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and SudoBot(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = '*•تمہ تعطيࢦ مغادࢪة اࢦبوت•*'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = '*•باࢦتاڪيد تمہ تعطيࢦ مغادࢪة اࢦبوت•*'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
send(msg.chat_id_, msg.id_,'*•تمہ مسـح سحڪاتڪ•*'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,'*•تمہ مسـح جۿاتڪ•*'  )  
