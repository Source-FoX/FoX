...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Source-FoX/Files_FoX/master/File_Bot/commands.lua") 
...
local json_file, res = https.request("https://raw.githubusercontent.com/FoXTEAM/Files_FoX/master/File_Bot/"..file)
if res == 200 then
