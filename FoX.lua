...
send(msg.chat_id_, msg.id_,'⚣︎ عذراً عـليك الاشـتࢪاك في قنـاة البـوت اولآ\n⚣︎قناة الاشتراك ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if HH6HHH(msg) then
...
local keyboard = {
	{'⚣︎معلومات الكيبورد⚣︎'},
	  {'⚣︎ضع اسم للبوت⚣︎'},
{'⚣︎تعطيل التواصل⚣︎','⚣︎تفعيل التواصل⚣︎'},
        {'⚣︎الاحصائيات⚣︎'},
{'⚣︎المشتركين⚣︎','⚣︎المجموعات⚣︎'},
{'⚣︎تنظيف المجموعات⚣︎','⚣︎تنظيف المشتركين⚣︎'},
{'المطورين⚣︎','المميزين عام⚣︎'},
{'⚣︎قائمه الكتم عام⚣︎','⚣︎قائمة حظر عام⚣︎'},
{'⚣︎اذاعه خاص⚣︎','⚣︎اذاعه⚣︎'},
{'⚣︎اذاعه بالتثبيت⚣︎'},
{'⚣︎اذاعه بالتوجيه خاص⚣︎','⚣︎اذاعه بالتوجيه⚣︎'},
{'⚣︎ضع كليشه ستارت⚣︎','⚣︎حذف كليشه ستارت⚣︎'},
{'⚣︎الاشتراك الاجباري⚣︎','⚣︎وضع قناة الاشتراك⚣︎'},
{'⚣︎تغير رساله الاشتراك⚣︎','⚣︎حذف رساله الاشتراك⚣︎'},
{'⚣︎تغير الاشتراك⚣︎'},
{'⚣︎تعطيل الاشتراك⚣︎','⚣︎تفعيل الاشتراك⚣︎'},
{'⚣︎تفعيل البوت خدمي⚣︎','⚣︎تعطيل البوت خدمي⚣︎'},
{'⚣︎جلب خزن البوت⚣︎'},
{'اضف كت تويت'},
{'حذف كت تويت'},
{'⚣︎تحديث السورس⚣︎'}, 
...
local Text = '⚣︎تم ارسال الملصق من ↓\n - '..Name
...
if text == '⚣︎تفعيل التواصل⚣︎' and HH6HHH(msg) then  
...
if text == '⚣︎تعطيل التواصل⚣︎' and HH6HHH(msg) then  
...
if text == '⚣︎تفعيل البوت خدمي⚣︎' and HH6HHH(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n تم تفعيل البوت خدمي ' 
else
Text = '\n⚣︎ البوت الان يتم تفعيله في المجموعات من قبل المشرفين + المالكين '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == '⚣︎تعطيل البوت خدمي⚣︎' and HH6HHH(msg) then  
if not database:get(bot_id..'Free:Bots') then
database:set(bot_id..'Free:Bots',true) 
Text = '\n تم تعطيل البوت خدمي' 
else
Text = '\n⚣︎ اهلا عزيزي المطور البوت تم تعطيله من التفعيل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == '⚣︎ضع كليشه ستارت⚣︎' and HH6HHH(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'⚣︎ ارسل لي الكليشه الان') 
return false
end
if text == '⚣︎حذف كليشه ستارت⚣︎' and HH6HHH(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'⚣︎تم حذف كليشه ستارت') 
end
if text == '⚣︎معلومات السيرفر⚣︎' and HH6HHH(msg) then 
...
echo '*⚣︎━━━━━━━━━⚣︎*\n⚣︎{ وحـده الـتـخـزيـن }⚣︎\n*>> '"$HardDisk"'*'
echo '*⚣︎━━━━━━━━━⚣︎*\n⚣︎{ الـمــعــالــج }⚣︎\n*>> '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
echo '*⚣︎━━━━━━━━━⚣︎*\n⚣︎{ الــدخــول }⚣︎\n*>> '`whoami`'*'
echo '*⚣︎━━━━━━━━━⚣︎*\n⚣︎{ مـده تـشغيـل الـسـيـرفـر }\n*>> '"$uptime"'*'
]]):read('*all'))  
end
if text == '⚣︎تحديث السورس⚣︎' and HH6HHH(msg) then 
os.execute('rm -rf FoX.lua')
os.execute('wget https://raw.githubusercontent.com/Source-FoX/FoX/master/FoX.lua')
send(msg.chat_id_, msg.id_,' ↫ تم تحديث السورس \n ⚣︎ لديك اخر اصدار لسورس فوكس ₂₀₂₁\n ⚣︎ الاصدار ↫ F𝗼𝘅₁')
dofile('FoX.lua')  
end
if text == 'الاصدار⚣︎' and HH6HHH(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⚣︎∫ اصدار سورس فوكس \n ⚣︎∫ الاصدار »{ 1.3v}')
end
if text == '⚣︎معلومات الكيبورد⚣︎' and HH6HHH(msg) then 
database:del(bot_id..'Sart:Bot') 
send(msg.chat_id_, msg.id_,'- اهلا عزيزى مطور اساسي \n- معلومات كتالي↓\n1⚣︎ الاحصائيات { لعرض عدد الكروبات، والمشتركين في البوت }\n2⚣︎ تفعيل التواصل{ لتفعيل التواصلعبر البوت خاص بك}\n3⚣︎ تعطيل التواصل{ لتعطيل التواصلعبر البوت خاص بك }\n4⚣︎ قائمه العام { لعرض المحظورين عام في البوت }\n5⚣︎ المطورين { لعرض المطورين في بوتك } \n6⚣︎ ضع اسم للبوت { لختيار اسم لبوت خاص بك }\n7⚣︎ حذف كليشه ستارت { حذف كليشه عندما يضغط العضو علي كلمه /start }\n8⚣︎ ضع كليشه ستارت { لختيار كلايشه /start حديده }\n9⚣︎ اذاعه { ارسال رساله لجميع الكروبات في بوتك }\n10⚣︎ اذاعه خاص { ارسال رساله لجميع مشتركين بوتك!}\n11⚣︎ تعطيل الاشتراك الاجباري { لتعطيل الاشتراك جباري خاص بوتك}\n12⚣︎ تفعيل الاشتراك الاجباري { لتفعيل الاشتراك الاجباري بوتك }\n13⚣︎اذاعه بالتوجيه { ارسال رساله بالتوجيه الي جميع الكروبات }\n14⚣︎ اذاعه بالتوجيه خاص { ارسال رساله بالتوجيه الي جميع المشتركين }\n15⚣︎ حذف رساله الاشتراك { لحذف رساله الاشتراك التي اضفتها }\n16⚣︎ تغير رساله الاشتراك { لتغير رساله الاشتراك خاصه بوتك وتختار غيرها }\n17⚣︎ تغير الاشتراك{لتغير ⚣︎الاشتراك الاجباري⚣︎ خاص بوتك واضافت قناة غيرها }\n18⚣︎ تفعيل الاشتراكالاول { لتفعيل الاشتراكجباري عندما تفعيل البوت اول مَـرّھٌ }\n19⚣︎ الاشتراك الاجباري { لظهار القناة مفعل الاشتراك عليها }\n20⚣︎ تفعيل البوت الخدمي { يمكن هاذا امر ان منشئ الكروب يفعل البوت م̷ـــِْن دون حتياجه لمطور البوت\n21⚣︎ تعطيل البوت الخدمي { يمك هل خاصيه ان تفعيل البوت اله مطورين البوت فقط }\n22⚣︎ تنظيف المشتركين { يمكنك ازاله المشتركين الوهمين عبر هل امر }\n23⚣︎ تنظيف الكروبات { يمكن ازاله المجموعات الوهميه عبر عل امر }\n24⚣︎ جلب نسخه احتياطيه { لعرض ملف المجموعات بوتك }\n25⚣︎ تحديث السورس { لتحديث السورس خاص بوتك }\n26⚣︎ الغاء { للغاء الامر الذي طلبته }\n===ء====================\n- اوامر كيبورت المطور اساسي معا شرح\n- قناة السورس [ضغط هنا](t.me/IIIIlI8)') 
end
if text == "⚣︎ضع اسم للبوت⚣︎" and HH6HHH(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⚣︎ ارسل لي الاسم الان ")  
return false
end
if text == '⚣︎الاحصائيات⚣︎' and HH6HHH(msg) then 
...
if text == '⚣︎المشتركين⚣︎' and HH6HHH(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⚣︎ المشتركين>{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == '⚣︎المجموعات⚣︎' and HH6HHH(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⚣︎ المجموعات> {`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المميزين عام⚣︎") and HH6HHH(msg) then
local list = database:smembers(bot_id..'Mamez:User')
t = "\n*⚣︎ قائمه مميزين العام \n *ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*\n*"
for k,v in pairs(list) do
...
if #list == 0 then
t = "⚣︎ لا يوجد مميز العام"
end
send(msg.chat_id_, msg.id_, t)
end

if text == ("المطورين⚣︎") and HH6HHH(msg) then
...
if #list == 0 then
t = "⚣︎ لا يوجد مطورين ⚣︎"
end
send(msg.chat_id_, msg.id_, t)
end
if text == ("⚣︎قائمة حظر عام⚣︎") and HH6HHH(msg) then
...
if #list == 0 then
t = "⚣︎ لا يوجد محظورين عام ⚣︎"
end
send(msg.chat_id_, msg.id_, t)
return false
end
if text == ("⚣︎قائمه الكتم عام⚣︎") and HH6HHH(msg) then
local list = database:smembers(bot_id..'Gmute:User')
t = "\n*⚣︎ قائمه المكتومين عام\n *ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*\n*"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."︙ "..k.."︙ >  ([@"..username.."])\n"
...
if text=="⚣︎اذاعه خاص⚣︎" and msg.reply_to_message_id_ == 0 and HH6HHH(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⚣︎ ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n⚣︎ للخروج ارسل الغاء ") 
return false
end 
if text=="⚣︎اذاعه⚣︎" and msg.reply_to_message_id_ == 0 and HH6HHH(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⚣︎ ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n⚣︎ للخروج ارسل الغاء ") 
return false
end  
if text=="⚣︎اذاعه بالتثبيت⚣︎" and msg.reply_to_message_id_ == 0 and HH6HHH(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n⚣︎للخروج ارسل الغاء ") 
return false
end 
if text=="⚣︎اذاعه بالتوجيه⚣︎" and msg.reply_to_message_id_ == 0  and HH6HHH(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⚣︎ ارسل لي التوجيه الان") 
return false
end 
if text=="⚣︎اذاعه بالتوجيه خاص⚣︎" and msg.reply_to_message_id_ == 0  and HH6HHH(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⚣︎ ارسل لي التوجيه الان") 
return false
end 
if text == '⚣︎جلب خزن البوت⚣︎' and HH6HHH(msg) then 
GetFile_Bot(msg)
end
if text == "⚣︎تنظيف المشتركين⚣︎" and HH6HHH(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'⚣︎ عذراً عـليك الاشـتࢪاك في قنـاة البـوت اولآ\n⚣︎قناة الاشتراك ] '..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
if text == "⚣︎تنظيف المجموعات⚣︎" and HH6HHH(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊𝒍𝒄𝒐𝒎𝒆 𝒇𝒐𝒙 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
send(msg.chat_id_, msg.id_,'⚣︎ عدد المجموعات الان > { '..#group..' }'..MODEDEVk..''..MODEDEV..'\n*⚣︎ الان عدد المجموعات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⚣︎ العضو > ['..result.title_..'](t.me/'..(username or 'IIIIlI8')..')'
...
usertext = '\n⚣︎ العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'IIIIlI8')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⚣︎العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'IIIIlI8')..')'
status  = '\n تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⚣︎العضو > '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⚣︎ العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIIlI8')..') \n ⚣︎'..MODEDEV1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⚣︎ العضو : {["..data.first_name_.."](T.ME/IIIIlI8)}\n ⚣︎ ["..FoX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⚣︎ عذرا » {["..data.first_name_.."](T.ME/IIIIlI8)}\n ⚣︎ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'⚣︎ تمِہ تفـ؏ـيل ࢦڪࢪۅپ .')
else
sendText(msg.chat_id_,'\n⚣︎ ۿۧهلا ﮼حِۢـياتيہ ~ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n⚣︎ تمِہ تفـ؏ـيل ࢦڪࢪۅپ .{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n⚣︎بواسطة {'..Name..'}'..
'\n⚣︎ايدي المجموعه {`'..IdChat..'`}'..
'\n⚣︎اسم المجموعه {['..NameChat..']}'..
'\n⚣︎عدد اعضاء المجموعه *{'..NumMember..'}*'..
'\n⚣︎الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' ⚣︎ تمِہ تـ؏ـطيل ࢦڪࢪۅپ .')
else
sendText(msg.chat_id_,'\n⚣︎ ۿۧهلا ﮼حِۢـياتيہ ~ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ⚣︎ تمِہ تـ؏ـطيل ࢦڪࢪۅپ .{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if text and text:match("^وضع قناة الاشتراك ⚣︎$") and HH6HHH(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⚣︎ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⚣︎" and HH6HHH(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⚣︎" and HH6HHH(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ⚣︎ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⚣︎" and HH6HHH(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⚣︎ تم تم تفعيل الاشتراك الاجباري \n على القناة > ["..addchusername.."]")
else
...
send(msg.chat_id_, msg.id_, t..'*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*\n⚣︎اضغط على الاسم ليتم نسخه')
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@IIIIlI8','⚣︎غنيلي = اغاني عشوائيه اهداء من البوت⚣︎','end')
...
if text and text:match("^⚣︎تغير الاشتراك⚣︎$") and HH6HHH(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⚣︎ حسنا ارسل لي معرف القناة') 
return false  
end
if text and text:match("^⚣︎تغير رساله الاشتراك⚣︎$") and HH6HHH(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⚣︎ حسنا ارسل لي النص الذي تريده') 
return false  
end
if text == "⚣︎حذف رساله الاشتراك⚣︎" and HH6HHH(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "⚣︎ تم مسح رساله الاشتراك ") 
return false  
end
if text and text:match("^⚣︎وضع قناة الاشتراك⚣︎$") and HH6HHH(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⚣︎ حسنا ارسل لي معرف القناة') 
return false  
end
if text == "⚣︎تفعيل الاشتراك⚣︎" and HH6HHH(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_,"⚣︎ الاشتراك الاجباري مفعل \n على القناة > ["..addchusername.."]")
else
...
if text == "⚣︎تعطيل الاشتراك⚣︎" and HH6HHH(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⚣︎ تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "⚣︎الاشتراك الاجباري⚣︎" and mHH6HHH(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⚣︎ تم تم تفعيل الاشتراك الاجباري \n على القناة > ["..addchusername.."]")
else
...
send(msg.chat_id_, msg.id_, '*⚣︎تم تفعيل الاضافات*')
database:set(bot_id.."AL:Sre:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '*⚣︎تم تعطيل الاضافات*')
database:set(bot_id.."AL:Sre:stats","❌")
end
...
send(msg.chat_id_, msg.id_, '⚣︎تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, '⚣︎تم الغاء كتم الاسم '..delBn)
...
t = "\n⚣︎قائمة الاسماء المكتومه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "⚣︎لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '⚣︎تم التفعيل سيتم كتم العضو الذي يضع الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تعطيل سيتم كتم العضو الذي يضع الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,'⚣︎تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,'⚣︎تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_,'⚣︎التوحيد هو '..s1..'\n ⚣︎ عدد الكتم هو : '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '⚣︎تم تفعيل التوحيد')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, "⚣︎عزيزي >>["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "IIIIlI8")..")\n⚣︎عليك وضع التوحيد ⪼ {`"..database:get(bot_id.."MODEDEV:teh"..msg.chat_id_).."`} بجانب اسمك\n⚣︎عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '⚣︎تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تعطيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تعطيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '⚣︎تم تعطيل تنبيه الصور')
...
Text = [[
*ʜɪ ғᴏx*
⚣︎ ۿݪأ ؏َـمݛي بـ سـۅࢪس فـۅڪس¹
𝘊𝘩 - [𝖋𝖔𝖝  𓅛](t.me/IIIIlI8) ⚣︎
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_,'*⚣︎  𝒘𝒊𝒍𝒄??𝒎𝒆 𝒇𝒐𝒙 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]*')
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*⚣︎ الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIIlI8')..')\n*⚣︎ الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'IIIIlI8')..') \n*⚣︎تم قفـل الدردشه*\n')  
end,nil)   
...
dofile('FoX.lua')  
send(msg.chat_id_, msg.id_, '*⚣︎تمہ تحديثہ جميـع الملفاتہ⚣︎*') 
end 
...
if text == ("حظر عام") and msg.reply_to_message_id_ and HH6HHH(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and HH6HHH(msg) then
...
if text and text:match("^حظر عام (%d+)$") and HH6HHH(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and HH6HHH(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and HH6HHH(msg) then
...
if text and text:match("^كتم عام (%d+)$") and HH6HHH(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and HH6HHH(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and HH6HHH(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and HH6HHH(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and HH6HHH(msg) then
...
if not my_ali then
send(msg.chat_id_, msg.id_,"* ⚣︎ امر all معطل*") 
return false  
end
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and HH6HHH(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == ("مسح المميزين عام") and HH6HHH(msg) then
database:del(bot_id..'Mamez:User')
send(msg.chat_id_, msg.id_, "\n⚣︎  تم مسح قائمة المميزين عام  ")
end
if text == ("المميز العام") and HH6HHH(msg) then
local list = database:smembers(bot_id..'Mamez:User')
t = "\n*⚣︎ قائمة مميز العام البوت \n *ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*\n*"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."︙"..k.." >  ([@"..username.."])\n"
...
if text == ("رفع مميز عام") and msg.reply_to_message_id_ and HH6HHH(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text and text:match("^رفع مميز عام @(.*)$") and HH6HHH(msg) then
...
if text and text:match("^رفع مميز عام (%d+)$") and HH6HHH(msg) then
...
if text == ("تنزيل مميز عام") and msg.reply_to_message_id_ and HH6HHH(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مميز عام @(.*)$") and HH6HHH(msg) then
...
if text and text:match("^تنزيل مميز عام (%d+)$") and HH6HHH(msg) then
...
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊𝒍𝒄𝒐??𝒆 𝒇𝒐𝒙 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
send(msg.chat_id_, msg.id_, '⚣︎تم مسح جميع الشيوخ في المجموعه  ')
end
if text == ("تاك للشيوخ") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n⚣︎قائمة شيوخ المجموعه \nٴ⚣︎━━━━⚣︎━━━━⚣︎\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_,'⚣︎لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n⚣︎< جط ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'⚣︎تم تعطيل الرفع من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Mote:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'NIII55')..')'
local  statuss  = '\n⚣︎الايدي > '..result.sender_user_id_..'\n⚣︎تم رفع العضو شيخ في المجموعه \n⚣︎استلم السبحه ولعكال وصير عاقل'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'NIII55')..')'
status  = '\n⚣︎الايدي > `'..result.sender_user_id_..'`\n⚣︎تم تنزيل العضو شيخ في المجموعه\n⚣︎تعال جيب السبحه ولعكال وسرسح'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
texts = '*⚣︎لا يوجد حساب بهاذا المعرف⚣︎*'
end
send(msg.chat_id_, msg.id_, texts)
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_,'⚣︎  𝑾??𝒍𝒄𝒐𝒎𝒆 𝒏𝒊𝒈𝒈𝒂 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
send(msg.chat_id_, msg.id_, '\n⚣︎ عذرا لا تستطيع طرد او حظر او كتم او تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "⚣︎لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚣︎ عذرا لا تستطيع طرد او حظر او كتم او تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚣︎ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n⚣︎العضو > ['..result.title_..'](t.me/'..(username or 'IIIIlI8')..')'
statusk  = '\n تم طرد العضو من هنا'
...
send(msg.chat_id_, msg.id_,'⚣︎  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒏??𝒈𝒈𝒂 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
send(msg.chat_id_, msg.id_, '\n⚣︎ عذرا لا تستطيع طرد او حظر او كتم او تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⚣︎ لعضو » *['..data.first_name_..'](t.me/'..(data.username_ or 'IIIIlI8')..')'
status  = '\n *⚣︎ تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⚣︎ العضو » *'..userid..''
...
database:srem(bot_id..'Mote:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎تم تنزيل العضو مطي في المجموعة 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎تم رفع العضو اثول في المجموعة 😭😹💞'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎تم تنزيل العضو اثول في المجموعة 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_, '⚣︎تم تنزيل جميع العروسات بالمجموعه ')
end
if text == ("تاك للعروسات") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n*⚣︎قائمه عروسات المجموعه \nٴ⚣︎━━━━⚣︎━━━━⚣︎\n*"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'NIII55')..')'
status  = '\n⚣︎الايدي > `'..result.sender_user_id_..'`\n⚣︎تم تنزيل العضو عروسه\n⚣︎طلعي من قائمه العروسات لجج'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data)
usertext = '\n⚣︎تم تنزيل العضو صخل في المجموعة 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎تم تنزيل العضو جلب في المجموعة 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎تم رفع العضو زاحف في المجموعة 😭😹💞'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎تم تنزيل العضو زاحف في المجموعة 😭😹💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎مو كتلك لتجرحني نزلتك من كلبي 😭💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊𝒍𝒄𝒐𝒎?? 𝒇𝒐𝒙   ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊𝒍𝒄𝒐𝒎?? ??𝒐𝒙   ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
function start_function(extra, result, success)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'⚣︎تم تعطيل الحظر من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
if result.id_ then
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'⚣︎ تم تعطيل حظر من قبل المنشئين') 
return false
end
if tonumber(userid) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "⚣︎ لا تسطيع حظر البوت")
...
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊𝒍??????𝒆 𝒇𝒐𝒙 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
send(msg.chat_id_, msg.id_,"*⚣︎ تمہ تفعيࢦ الࢪابط*") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"*⚣︎ تمہ تعطيࢦ الࢪابط*") 
return false end
end
...
send(msg.chat_id_, msg.id_,"*⚣︎ الࢪابط معطࢦ*") 
return false  
end
...
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊𝒍𝒄𝒐𝒎𝒆 𝒇𝒐?? ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
if text == 'مسح كليشه المطور' and HH6HHH(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⚣︎ تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and HH6HHH(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⚣︎ بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIIlI8')..') \n⚣︎تم الامر بنجاح\n')  
end,nil)   
end
...
send(msg.chat_id_, msg.id_,'⚣︎  𝒘𝒊??𝒄𝒐𝒎𝒆 𝒇𝒐𝒙 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]')
end
return false
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⚣︎ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'IIIIlI8')..')'..'\n ⚣︎ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'*⚣︎تستطيع التنظيف 1000 رساله كحد اقصى*') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,'*⚣︎  𝒘??𝒍𝒄𝒐𝒎𝒆 ??𝒐𝒙 ⚣︎\n⚣︎ لايمكنك استخدام البوت ⚣︎\n⚣︎ عليك الاشتراك في القناة ⚣︎\n⚣︎ اشترك اولا ['..database:get(bot_id..'add:ch:username')..'⚣︎]*')
end
return false
end
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
...
if database:get(bot_id..'Bc:Bots') and not HH6HHH(msg) then 
...
if text == ("مسح ردود المطور") and HH6HHH(msg) then 
...
if text == ("ردود المطور") and HH6HHH(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⚣︎ قائمة ردود المطور \n*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and HH6HHH(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and HH6HHH(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⚣︎كانت لحظات جميله قضينا أوقات ممتعه هنا وحان موعد الفراق شكرا لكم 💘🧸*') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = '\n⚣︎تمہ تفعيࢦ مغادࢪة اࢦبوت⚣︎'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = '\n⚣︎باࢦتاڪيد تمہ تفعيࢦ مغادࢪة اࢦبوت⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and HH6HHH(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = '\n⚣︎تمہ تعطيࢦ مغادࢪة اࢦبوت⚣︎'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = '\n⚣︎باࢦتاڪيد تمہ تعطيࢦ مغادࢪة اࢦبوت⚣︎'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n⚣︎تمہ تفعيࢦ ࢪدود اࢦمديࢪ⚣︎'
database:del(bot_id..'Reply:Manager'..msg.chat_id_)  
else
Text = '\n⚣︎باࢦتاڪيد تمہ تفعيࢦ ࢪدود اࢦمديࢪ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تعطيࢦ ࢪدود اࢦمديࢪ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تعطيࢦ ࢪدود اࢦمديࢪ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تفعيࢦ ࢪدود اࢦمطوࢪ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تفعيࢦ ࢪدود اࢦمطوࢪ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تعطيࢦ ࢪدود اࢦمطوࢪ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تعطيࢦ ࢪدود اࢦمطوࢪ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تفعيࢦ اࢦايديہ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تفعيࢦ اࢦايديہ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تعطيࢦ اࢦايديہ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تعطيࢦ اࢦايديہ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تفعيࢦ اࢦايديہ باࢦصوࢪۿ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تفعيࢦ اࢦايديہ باࢦصوࢪۿ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⚣︎تمہ تعطيࢦ اࢦايديہ باࢦصوࢪۿ⚣︎' 
else
Text = '\n⚣︎باࢦتاڪيد تمہ تعطيࢦ اࢦايديہ باࢦصوࢪۿ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⚣︎ العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'MODEDEV')..') '
status  = '\n⚣︎ الايدي > '..result.sender_user_id_..'\n⚣︎تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,'⚣︎ ID ⚣︎ ('..iduser..')\n⚣︎USE ⚣︎ ('..username..')\n⚣︎ STA ⚣︎ ('..rtp..')\n⚣︎ MSG ⚣︎ ('..Msguser..')')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local amir = ' *⚣︎ عدد الادمنيه : *'..data.administrator_count_..
...
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'* ⚣︎ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*') 
return false  
end
if (data and data.code_ and data.code_ == 3) then 
send(msg.chat_id_, msg.id_,' *⚣︎البوت ليس ادمن يرجى ترقيتي !*') 
return false  
end
...
send(msg.chat_id_, msg.id_,'*⚣︎تمہ طࢪدڪ مِہטּ الڪࢪوبہ⚣︎*') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,'*⚣︎تمہ تعطيࢦ امࢪ اطࢪدنيہ⚣︎*') 
end
end
...
send(msg.chat_id_, msg.id_,' *⚣︎لا استطيع اصيح معرف قنوات*') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'* ⚣︎لا استطيع اصيح معرف بوتات*') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,'* ⚣︎تعال حبي يصيحونك بل كروب *[@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' *⚣︎تم تعطيل امر صيح*') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'*⚣︎انتہ منشئ اࢦڪࢪوبہ⚣︎*') 
return false
end
...
send(msg.chat_id_, msg.id_,'*⚣︎انتہ دخلتہ عبࢪ ࢪابط ࢦتࢦح⚣︎*') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'*⚣︎تمہ تعطيࢦ امࢪ منو ضافنيہ⚣︎*') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = '⚣︎تمہ تفعيࢦ امࢪ منو ضافنيہ⚣︎'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = '\n ⚣︎باࢦتاڪيد تمہ تفعيࢦ امࢪ منو ضافنيہ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ⚣︎تمہ تعطيࢦ امࢪ منو ضافنيہ⚣︎'
else
Text = '\n ⚣︎باࢦتاڪيد تمہ تعطيࢦ امࢪ منو ضافنيہ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = '\n ⚣︎تمہ تفعيࢦ امࢪ صيح⚣︎'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = '\n ⚣︎باࢦتاڪيد تمہ تفعيࢦ امࢪ صيح⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ⚣︎باࢦتاڪيد تمہ تعطيࢦ امࢪ صيح⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = '\n ⚣︎تمہ تفعيࢦ امࢪ اطࢪدنيہ⚣︎'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = '\n ⚣︎باࢦتاڪيد تمہ تفعيࢦ امࢪ اطࢪدنيہ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ⚣︎تمہ تعطيࢦ امࢪ اطࢪدنيہ⚣︎'
else
Text = '\n ⚣︎باࢦتاڪيد تمہ تعطيࢦ امࢪ اطࢪدنيہ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_,"⚣︎اࢦصوࢪۿ معطࢦۿ⚣︎") 
return false  
end
...
Text = ' ⚣︎ عدد جهاتك > ['..Num..'](https://t.me/IIIIlI8) ⚣︎'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'* ⚣︎ عدد الكروبات الان » { '..#group..' }'..FoXk..''..FoX..'\n*- الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n*')   
end
end
end,nil)
end
...
if text =='تغيير المطور الاساسي' and HH6HHH(msg) then
send(msg.chat_id_, msg.id_,'⚣︎ ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'DEV:Sudo:T',true) 
end
if text =='تغيير المطور الاساسي' and not HH6HHH(msg) then
...
if text == 'استعاده الاوامر' and HH6HHH(msg) then
...
Text = [[
*ʜɪ ғᴏx*
*⚣︎اۿلا ؏ـزيزي الاوامࢪ ڪلتالي⚣︎*
*  ٴ⚣︎○⚣︎○⚣︎○⚣︎○⚣︎*
*⚣︎م𝟭 ➭- اوامࢪ الحمايهہ*
*⚣︎م𝟮 ➭- اوامࢪ اࢦتعطيࢦ ~ اࢦتفعيࢦ*
*⚣︎م𝟯 ➭- اوامࢪ ضع ~ اضفہ*
*⚣︎م𝟰 ➭- اوامࢪ مسح ~ حذفہ*
*⚣︎م𝟱 ➭- اوامࢪ تنزيࢦ ~ ࢪفع ~ اࢦتغيࢪ*
*⚣︎م𝟲 ➭- اوامࢪ اࢦڪروبہ*
*⚣︎م𝟳 ➭- اوامࢪ اࢦتسلية*
*⚣︎م𝟴 ➭- اوامࢪ مطوࢪ اࢦبوتہ*
*  ٴ⚣︎○⚣︎○⚣︎○⚣︎○⚣︎*
𝘊𝘩 - [𝖋𝖔𝖝  𓅛](t.me/IIIIlI8)⚣︎
]]
keyboard = {} 
...
*⚣︎ امسح*
*⚣︎ صࢦلاحيهہ *
*⚣︎ قائمهہ منع اࢦمتحࢪڪات*
*⚣︎ قائمهہ منع اࢦصـﯡࢪ*
*⚣︎ قائمهہ منع اࢦمࢦصقات*
*⚣︎ مسح قائمهہ المنع*
*⚣︎ اࢦمحذﯡفيـטּ*
*⚣︎ اࢦاﯡامࢪ اࢦمضافهہ *
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
...
*⚣︎ اࢦادمنيهہ *
*⚣︎ ادمن باࢦڪروب*
*⚣︎ ادمن بڪࢦ اࢦصࢦلاحيات*
*⚣︎ اࢦقيود*
*⚣︎ تنزيࢦ جميع الࢪتب*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ اوامࢪ اࢦتغيࢪ*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ تغيࢪ ࢪد اࢦمطوࢪ + اسم*
*⚣︎ تغيࢪ ࢪد منشئ اࢦاساسي + اسم*
*⚣︎ تغيࢪ ࢪد اࢦمنشئ + اسم*
*⚣︎ تغيࢪ ࢪد اࢦمديࢪ + اسم*
*⚣︎ تغيࢪ ࢪد اࢦادمن + اسم*
*⚣︎ تغيࢪ ࢪد اࢦمميز + اسم*
*⚣︎ تغيࢪ ࢪد اࢦعضـﯡ + اسم*
*⚣︎ تغيࢪ امࢪ اࢦاوامࢪ*
*⚣︎ تغيࢪ امࢪ م1 ~ الئ م10*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
𝘊𝘩 - [𝖋𝖔𝖝  𓅛](t.me/IIIIlI8)⚣︎
]]
send(msg.chat_id_, msg.id_,(help_text or Text)) 
...
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ استعاده اࢦاوامࢪ*
*⚣︎ صيح › تاڪ › اࢦمميزين : اࢦادمنيه : اࢦمدࢪاء : اࢦمنشئين : اࢦمنشئين اࢦاساسين : لࢦماࢦڪ*
*⚣︎ ڪشف اࢦقيـﯡد *
*⚣︎ تعين اࢦايدي*
*⚣︎ تغيࢪ اࢦايدي*
*⚣︎ اࢦحساب + ايدي اࢦحساب*
*⚣︎ تنظيف + اࢦعدد*
*⚣︎ تنزيࢦ اࢦڪࢦ*
*⚣︎ تنزيࢦ جميع اࢦࢪتب*
*⚣︎ منع + بࢪد*
*⚣︎ الصوࢪ + متحࢪڪه + مࢦصق *
*⚣︎ حظࢪ › ڪتم › تقيد › طࢪد*
*⚣︎ اࢦمحظـﯡࢪيـטּ › اࢦمڪتـﯡميـטּ › المقيدين*
*⚣︎ اࢦغاء ڪتم + حظࢪ + تقيد › باࢦࢪد و معࢪف و ايدي*
*⚣︎ تقيد ~ ڪتم + اࢦࢪقم + ساعه*
*⚣︎ تقيد ~ ڪتم + اࢦࢪقم + يوم*
*⚣︎ تقيد ~ ڪتم + اࢦࢪقم + دقيقهہ *
*⚣︎ تثبيت ~ الغاء تثبيت*
*⚣︎ اࢦتࢪحيب*
*⚣︎ اࢦغاء تثبيت اࢦكل *
*⚣︎ ڪشف اࢦبـﯡتات*
*⚣︎ اࢦصࢦلاحيات*
*⚣︎ ڪشف › برد › بمعرف › ايدي*
*⚣︎ تاڪ ࢦࢦكࢦ*
*⚣︎ تاڪ ࢦࢦمشرفيـטּ*
*⚣︎ اعدادات اࢦمجمـﯡعهہ *
*⚣︎ عدد اࢦڪࢪوب*
*⚣︎ ࢪدود اࢦمديࢪ*
*⚣︎ اسم بوت + اࢦࢪتبهہ *
*⚣︎ اࢦاﯡامࢪ اࢦمضافهہ *
...
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ تفعيࢦ › تعطيࢦ *
*⚣︎ اࢦمجموعات › اࢦمشترڪين › اࢦاحصائيات*
*⚣︎ ࢪفع › تنزيࢦ منشئ اساسي*
*⚣︎ مسح اࢦاساسين › اࢦمنشئين اࢦاساسين*
*⚣︎ مسح اࢦمنشئين › اࢦمنشئين*
*⚣︎ ࢪفع › تنزيࢦ مالڪ*
*⚣︎ مسح قائمه اࢦماࢦڪ *
*⚣︎ اسم › ايدي + بوت غادࢪ*
*⚣︎ اذاعه *
...
*⚣︎ قائمه اࢦعام*
*⚣︎ مسح قائمه اࢦعام*
*⚣︎ جࢦب نسخه اࢦاحتياطيه*
*⚣︎ ࢪفع نسخه اࢦاحتياطيه*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ اذاعه خاص*
*⚣︎ اذاعه*
*⚣︎ اذاعه باࢦتوجيه*
*⚣︎ اذاعه باࢦتوجيه خاص*
*⚣︎ اذاعه باࢦتثبيت*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ جࢦب نسخه اࢦبوت*
*⚣︎ ࢪفع نسخه اࢦبوت*
*⚣︎ ضع عدد اࢦاعضاء + اࢦعدد*
*⚣︎ ضع كࢦيشه اࢦمطوࢪ*
*⚣︎ تفعيࢦ › تعطيࢦ اࢦاذاعه*
*⚣︎ تفعيࢦ › تعطيࢦ اࢦبوت اࢦخدمي*
*⚣︎ تفعيࢦ › تعطيࢦ اࢦتواصࢦ*
*⚣︎ تغيࢪ اسم اࢦبوت*
*⚣︎ اضف › حذف ࢪد ࢦࢦڪࢦ*
*⚣︎ ࢪدود اࢦمطوࢪ*
*⚣︎ مسح ࢪدود اࢦمطوࢪ*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ اࢦاشتراڪ اࢦاجباࢪي*
*⚣︎ تعطيࢦ الاشتࢪاڪ اࢦاجباࢪي*
*⚣︎ تفعيࢦ اࢦاشتࢪاڪ اࢦاجباࢪي*
*⚣︎ حذف ࢪساࢦه اࢦاشتࢪاڪ*
*⚣︎ تغيࢪ ࢪساࢦه اࢦاشتࢪاڪ*
*⚣︎ تغيࢪ اࢦاشتࢪاڪ*
*ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*
*⚣︎ اࢦاحصائيات*
*⚣︎ اࢦمشترڪين*
*⚣︎ اࢦمجموعات *
*⚣︎ تفعيࢦ › تعطيࢦ اࢦمغادره*
*⚣︎ تنظيف اࢦمشتࢪڪين*
*⚣︎ تنظيف اࢦڪࢪﯡبات*
 ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵
𝘊𝘩 - [𝖋𝖔𝖝  𓅛](t.me/IIIIlI8)⚣︎
...
audios = json:decode(data)
if audios.Info == true then
local Text ='⚣︎تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' ⚣︎الف مبروك لقد فزت \n ⚣︎للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ⚣︎الف مبروك لقد فزت \n ⚣︎للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," ⚣︎عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' ⚣︎مبروك فزت ويانه وخمنت الرقم الصحيح\n ⚣︎تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' ⚣︎اوبس لقد خسرت في اللعبه \n ⚣︎حظآ اوفر في المره القادمه \n ⚣︎كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' ⚣︎اوبس تخمينك غلط \n ⚣︎ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n ⚣︎اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' ⚣︎ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' ⚣︎سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," ⚣︎عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' ⚣︎مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n ⚣︎لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' ⚣︎للاسف لقد خسرت \n ⚣︎المحيبس بل ايد رقم { '..GETNUM..' }\n ⚣︎حاول مره اخرى للعثور على المحيبس')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹⚣︎› 👊 ‹⚣︎› 👊 ‹⚣︎› 👊 ‹⚣︎› 👊 ‹⚣︎› 👊
 ⚣︎اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 ⚣︎الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يدز الاختلاف » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ⚣︎حل المسأله الرياضيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ⚣︎ترجم الكلمات الاتيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ⚣︎اسرع واحد يكمل المثل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
Text_Games = [[
*⚣︎اوامر الالعاب كتالي*
   **ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*ٴ* 
*⚣︎تفعيل الالعاب ⚣︎ لتفعيل العبه °*
*⚣︎تعطيل الالعاب ⚣︎ لتعطيل العبه*
   **ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*ٴ* 
*⚣︎الالعاب الخاصه بسورس*
   **ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*ٴ* 
*⚣︎لعبه البات ↫ لعبة المحيبس*
*⚣︎لعبه التخمين ↫ لعبة البحث*
*⚣︎لعبه الاسرع ↫ لعبة اسرع شخص*
*⚣︎لعبه السمايلات ↫ لعبة المطابقه *
*⚣︎لعبه المختلف ↫ لعبة الذكاء*
*⚣︎لعبه الرياضيات ↫ لعبة الارقام*
*⚣︎لعبه الانكليزي ↫ لعبة ترجمه*
*⚣︎لعبه الامثله ↫ لعبة تصحيح *
*⚣︎لعبه العكس ↫ لعبة عكس الكلمات*
*⚣︎لعبه الحزوره ↫لعبة التفكير *
*⚣︎لعبه المعاني ↫ العبه الشهيره *
* ⚣ بوت{ @B_09bot }يحتوي على أكثر 120 لعبه حديثه و4k اسئله كت تويت *
   **ٴ𝁵𝁵𝁵𝁵FX𝁵𝁵𝁵𝁵*ٴ* 
𝘊𝘩 - [𝖋𝖔𝖝  𓅛](t.me/IIIIlI8)⚣︎
]]
...
send(msg.chat_id_, msg.id_, '⚣︎ تم تفعيل الردود')
database:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل الردود' and Manager(msg) then  
send(msg.chat_id_, msg.id_, '⚣︎ تم تعطيل الردود')
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"⚣︎اهــلا عزيزي\n⚣︎تم رفع العضو مرتك بنجاح★\nالآن يمكنكم أخذ راحتكم★"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local texting = {"܁⚣︎كلش حباب وهاي 🦄💞","܁⚣︎الكياته تبعه تقرا 1000 🥺💞","܁⚣︎اطلق شخص شحبه 🥺💞","زغبا 😹💞.","܁⚣︎يوتيوبر رب المعيدي 😹💞"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
return false
end
...
if FoX1_Msg then    
send(msg.chat_id_, msg.id_," ⚣︎ "..FoX1_Msg)
