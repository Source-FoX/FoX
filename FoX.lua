...
local Text = '✶┋اليك الاوامر🔽\n'
keyboard = {}
keyboard.inline_keyboard = {
{{text="م1",callback_data="/m1"},{text="م2",callback_data="/m2"}},
{{text="م3",callback_data="/m3"}},
{{text="م4",callback_data="/m4"},{text="م5",callback_data="/m5"}},
{{text="م6",callback_data="/m6"},{text="م7",callback_data="/m7"}},
{{text="م8",callback_data="/m8"}},
{{text="م9",callback_data="/m9"},{text="م10",callback_data="/m10"}},
}
